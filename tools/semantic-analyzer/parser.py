...
def parse(exit_code, log, output):
    ...
    for issue in issues.get("results", { "detectors" : [] }).get("detectors", []):
        finding = {}
        ...
        if m:
            ...
            finding["filename"] = source_mapping["filename_relative"]
        for element in elements:
            if element.get("type") == "function":
                finding["function"] = element["name"]
                finding["contract"] = element["type_specific_fields"]["parent"]["name"]
                break
